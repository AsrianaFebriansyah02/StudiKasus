          ...
          <div class=" col-md-5 offset-md-1">
            <div class="detail-box">
              ...
              <p>
                ...
                Get the official merch
                from your favorite artists!
                Official e-commerce
                for the fans around the world, Weverse Shop
              </p>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="img-box">
            <img src="images/ikon3-removebg-preview.png" alt="">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="box ">
              <div class="client_id">
                <div class="img-box">
                  <img src="images/pp1.png" alt="" class="img-fluid">
                </div>
                <h4>
                  Barbara
                </h4>
              ...
              <div class="detail-box">
                <p>
                  The arrival was fast and the quality of delivery was excellent. I really enjoyed opening the box. Even the quality of the Light Stick was the best it could be. You have kept it well protected.
                </p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="box ">
              <div class="client_id">
                <div class="img-box">
                  <img src="images/pp2.png" alt="" class="img-fluid">
                </div>
                <h4>
                  Cassandra
                </h4>
              ...
              <div class="detail-box">
                <p>
                  This product is just amazing! I absolutely loved it. It’s already on my shelf and I can’t wait to have enough savings to buy the rest of the photofolios!!!
                </p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="box ">
              <div class="client_id">
                <div class="img-box">
                  <img src="images/pp3.png" alt="" class="img-fluid">
                </div>
                <h4>
                  Flora
                </h4>
              ...
              <div class="detail-box">
                <p>
                  The shipping was fast and the album wasn't damaged. Thank you so much <3 </p>
              </div>
            </div>
          </div>
        </div>
